...
@jarvis_cmd(pattern="weeb ?(.*)")
async def weebify(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        await jar.edit("What I am Supposed to Weebify? Please Give Text Sir")
        return
    ...
    await jar.eor(string)


@jarvis_cmd(pattern="tantext ?(.*)")
async def tantxt(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        await jar.edit("What I am Supposed to tanify? Please Give Text Sir")
        return
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
@jarvis_cmd(pattern="linetext ?(.*)")
async def linetxt(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        await jar.edit("What I am Supposed to linefy? Please Give Text Sir")
        return
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
    ...
    await jar.edit(string)


@jarvis_cmd(pattern="boxtext ?(.*)")
async def boxtxt(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        return await jar.edit("What I am Supposed to boxify? Please Give Text Sir")
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
@jarvis_cmd(pattern="bubbletext ?(.*)")
async def bubbletxt(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        return await jar.edit("What I am Supposed to bubblify? Please Give Text Sir")
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
@jarvis_cmd(pattern="cursive ?(.*)")
async def cursive(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
...
@jarvis_cmd(pattern="greekify ?(.*)")
async def greektext(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        return await jar.edit("What I am Supposed to greekify? Please Give Text Sir")
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
@jarvis_cmd(pattern="sorcify ?(.*)")
async def sorcerertext(jar):
    ...
    if not args and jar.is_reply:
        ...
        args = get.text
    if not args:
        await jar.edit("What I am Supposed to sorcify? Please Give Text Sir")
        return
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
@jarvis_cmd(pattern="fraktify ?(.*)")
async def frakturtext(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        await jar.edit("What I am Supposed to fraktify? Please Give Text Sir")
        return
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
@jarvis_cmd(pattern="rusify ?(.*)")
async def rusitext(jar):
    args = jar.pattern_match.group(1)
    if not args and jar.is_reply:
        get = await jar.get_reply_message()
        args = get.text
    if not args:
        return await jar.edit("What I am Supposed to rusify? Please Give Text Sir")
    string = "".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
